  ...
  return (
    <SafeAreaView style={styles.contenedor}>
      ...
      <View style={styles.contenedorAccionPrincipal}>
        ...
        <TouchableOpacity style={styles.botonPuntoControl} onPress={() => sendLocation(name as string, location?.coords.latitude.toFixed(6), location?.coords.longitude.toFixed(6))}>
